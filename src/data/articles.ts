...
export const whatIsWattageArticle: Article = {
  ...
  content: [
    ...
    { type: "paragraph", text: "The higher the wattage of a light, the more power it can draw and, in most cases, the more light it can produce." },
    { type: "paragraph", text: "Every lighting fixture has a wattage rating. You can usually find it:" },
    { type: "paragraph", text: "On the product body" },
    { type: "paragraph", text: "In the user manual" },
    { type: "paragraph", text: "On the product packaging" },
    { type: "paragraph", text: "Or directly in the product name" },
    ...
    { type: "paragraph", text: "Amaran 300C = Up to 300 Watts" },
    { type: "paragraph", text: "Aputure 600D = Up to 600 Watts" },
    { type: "paragraph", text: "Aputure XT26 = Up to 2,600 Watts" },
    { type: "paragraph", text: "Understanding the number in the name helps you quickly know how powerful the light can be." },
    ...
    { type: "paragraph", text: "On set, you rarely use a light at full power all the time. Most lights have a dimmer that allows you to control their brightness." },
    { type: "paragraph", text: "Let's say you're filming a podcast and using an Aputure 600D inside a lantern softbox." },
    { type: "paragraph", text: "If the light is set to 100% brightness, you're using the full 600 Watts of available output." },
    { type: "paragraph", text: "But what if the light looks too bright?" },
    { type: "paragraph", text: "You can reduce the dimmer." },
    { type: "paragraph", text: "For example:" },
    { type: "paragraph", text: "100% Brightness = 600 Watts" },
    { type: "paragraph", text: "80% Brightness = 480 Watts" },
    { type: "paragraph", text: "60% Brightness = 360 Watts" },
    { type: "paragraph", text: "50% Brightness = 300 Watts" },
    { type: "paragraph", text: "This means that when you lower the dimmer, you're also reducing the amount of light being produced." },
    ...
    { type: "paragraph", text: "Each light can produce up to 300 Watts." },
    { type: "paragraph", text: "If all 10 lights are set to 50% brightness, each light is producing approximately 150 Watts." },
    { type: "paragraph", text: "That means:" },
    { type: "paragraph", text: "150 Watts × 10 Lights = 1,500 Watts of total light output" },
    { type: "paragraph", text: "Understanding this helps you estimate how much lighting power is being used across your entire setup." },
    ...
    { type: "paragraph", text: "Imagine you know you'll need around 400 Watts of light for a shoot." },
    { type: "paragraph", text: "You have two options:" },
    { type: "paragraph", text: "Option A" },
    { type: "paragraph", text: "Two 200-Watt COB lights" },
    { type: "paragraph", text: "Option B" },
    { type: "paragraph", text: "Two 300-Watt COB lights" },
    { type: "paragraph", text: "Option B gives you more flexibility." },
    { type: "paragraph", text: "Even if you only use 400 Watts total, you'll still have extra power available if:" },
    { type: "paragraph", text: "The room is larger than expected" },
    { type: "paragraph", text: "Your softbox absorbs more light" },
    { type: "paragraph", text: "You move the light farther away" },
    { type: "paragraph", text: "You need additional brightness later" },
    { type: "paragraph", text: "Think of it like having a larger fuel tank in a car. You may not need all of it today, but you'll appreciate having the extra capacity when the situation changes." },
    ...
    { type: "paragraph", text: "As a beginner, remember these three things:" },
    { type: "paragraph", text: "Higher wattage usually means more available light." },
    { type: "paragraph", text: "The dimmer controls how much of that power you're actually using." },
    { type: "paragraph", text: "Having extra lighting power available is usually better than not having enough." },
    { type: "paragraph", text: "Understanding wattage is one of the foundations of lighting, and once you grasp it, choosing lights and planning your shoots becomes much easier." },
  ],
};